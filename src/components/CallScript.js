...
export default function getCallScript(variables) {
  ...
  <IMPORTANT>
  ANYTHING INSIDE OF PARENTHESES "()" is a directive and should not be said out loud.
  DO NOT REPEAT YOUR QUESTIONS. PRIOR TO ASKING AN INTERVIEW QUESTION THINK ABOUT THE PREVIOUS CONVERSATION HISTORY AND AVOID REPEATING.
  YOU WILL BE PAID BASED ON YOUR PERFORMANCE CONDUCTING THIS INTERVIEW. IF YOU REPEAT ANY INTERVIEW QUESTION YOU MAY BE FIRED.
  </IMPORTANT>
